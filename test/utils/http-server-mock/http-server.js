	...
	actions: {
		...
		postStream(ctx) {
			return new Promise((resolve, reject) => {
				const stream = fs.createWriteStream(`./test/utils/http-server-mock/POSTfile.md`);
		...
		putStream(ctx) {
			return new Promise((resolve, reject) => {
				const stream = fs.createWriteStream(`./test/utils/http-server-mock/PUTfile.md`);
		...
		patchStream(ctx) {
			return new Promise((resolve, reject) => {
				const stream = fs.createWriteStream(`./test/utils/http-server-mock/PATCHfile.md`);
